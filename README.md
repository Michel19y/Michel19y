...
| Projeto | Descrição |
|---|---|
| [SpotifeiFamilia](https://github.com/Michel19y/SpotifeiFamilia) | App de console (EF Core) simulando um serviço de streaming com plano família: 2FA (TOTP + QR code), controle parental, restrição de conteúdo |
| [MeuDiarioSenac](https://github.com/Michel19y/MeuDiarioSenac) | Diário pessoal com login por usuário, arquitetura em camadas (MVC) e persistência via Entity Framework Core |
